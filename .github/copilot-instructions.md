# GitHub Copilot instructions — podocarpus-nest-backend

Rules for Copilot (and other AI assistants) in this repo. Claude Code reads the same
...
After finishing any meaningful task in this repo, add an entry to `WORKLOG.md` at the
repo root. This is the project's running record so nobody has to dig through git history
...
project activity, not just code edits. When in doubt whether something is worth logging,
log it briefly.
